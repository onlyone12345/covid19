				...
				<div class="box box-default">
					<div class="box-header with-border">
						...
						<div class="pull-right">
							<a href="<?php echo site_url() ?>backend/data/tambah-data" type="button" class="btn btn-success button-sm btn-flat"><i class="fa fa-plus"></i> Tambah Data</a>
						</div>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
...
<script>
	$(document).ready(function() {
		...
		$('#datatable_custom tbody').on('click', '.delete', function(){
			...
			$('#modal-delete input[name=id_pasien]').val(id_pasien);
