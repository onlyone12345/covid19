...
<div class="login-box">
  ...
  <div class="login-logo">
    <img src="<?php echo site_url() ?>/assets/img/logo.png" alt="Logo Lamsel" height="80px"> <br>
    <a href="<?php echo site_url() ?>"><b class="text-red">Covid19 Lamsel</b></a>
  </div>

    <form action="<?php echo site_url() ?>login/login-action" method="POST">
