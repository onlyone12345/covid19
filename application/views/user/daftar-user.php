				...
				<div class="box box-default">
					<div class="box-header with-border">
						...
						<div class="pull-right">
							<a href="<?php echo site_url() ?>user/tambah" type="button" class="btn btn-success button-sm btn-flat"><i class="fa fa-plus"></i> Tambah User</a>
						</div>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
...
<script>
	$(document).ready(function() {
		...
		$('#datatable_custom tbody').on('click', '.delete', function(){
			...
			$('#modal-delete input[name=username]').val(username);
